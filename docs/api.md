...
- GET /retention: asOf, timeZone, ordered categories and children. Children contain assessed, strength (null when unassessed), breadth, reinforcement, recency, weightedRevisits, distinctSolved, lastPracticedAt, reason and ordering metadata. Ranking numbers are internal and not displayed.
