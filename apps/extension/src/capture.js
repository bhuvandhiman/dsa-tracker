...
globalThis.DsaCapture = {
  start(doc, page, runtime) {
    ...
    async function open(evidence = {}) {
      ...
      const style = node('style', ':host{position:fixed;right:16px;top:80px;z-index:2147483647;width:340px;max-width:calc(100vw - 32px);font:14px/1.5 system-ui;color:#edf3f7;color-scheme:dark}*{box-sizing:border-box}section{background:#161d27;border:1px solid #354254;border-radius:16px;padding:22px;box-shadow:0 12px 48px #0004;max-height:calc(100dvh - 100px);overflow:auto}header{display:flex;justify-content:space-between;align-items:center}h2{font-size:20px;line-height:1.3;margin:16px 0}fieldset{border:0;padding:0;margin:18px 0}legend{font-weight:650;margin-bottom:8px}label{display:flex;gap:10px;align-items:center;padding:7px 0;cursor:pointer}input{accent-color:#5ee6a8;width:17px;height:17px}p{margin:8px 0;overflow-wrap:anywhere;font-size:12px;color:#9aa9ba}button{font:inherit;cursor:pointer;border:0;border-radius:8px;padding:10px;background:#5ee6a8;color:#09251b;width:100%}button.close{width:auto;background:transparent;color:#9aa9ba;padding:4px 8px}button:disabled{opacity:.6;cursor:wait}button:focus-visible,input:focus-visible{outline:3px solid #f3b562;outline-offset:3px}select{background:#0d1117;color:#edf3f7;border:1px solid #354254;border-radius:8px}select:focus-visible{outline:2px solid #f3b562;outline-offset:3px}label:hover{color:#5ee6a8}[role=status]{color:#f3b562}');
